...
public class GlobalRepository {
            ...
            public void onResponse(Call<WebResponse<JsonObject>> call, Response<WebResponse<JsonObject>> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    try {
                        ...
                        JSONObject datatable = dataz.optJSONObject("dataTable");
                        if (datatable != null) {
                            callback.onSuccess("Password change request successful");
                        } else {
    ...
    public void support(String appID, SupportModel model, final OnApiResponse<String> callback){
        ...
        retrofitProxyService.support(appID,model,SharedPref.getApp_token(context)).enqueue(new Callback<WebResponse<JsonObject>>() {
            @Override
            public void onResponse(Call<WebResponse<JsonObject>> call, Response<WebResponse<JsonObject>> response) {
    ...
    public void kycUploads(String appID,String kycID,String custID, List<MultipartBody.Part>bodylist,final OnApiResponse<String> callback){
    ...
    public void downloadPofilePix(String custID,final OnApiResponse<ImageDetails> callback){
        ...
        retrofitProxyService.getProfilePix(custID,SharedPref.getApp_token(context)).enqueue(new Callback<WebResponse<ImageDetails>>() {
            @Override

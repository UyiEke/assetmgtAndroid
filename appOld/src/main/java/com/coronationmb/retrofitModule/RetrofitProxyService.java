...
public interface RetrofitProxyService {
    ...
    @POST("support/{appId}")
    Call<WebResponse<JsonObject>> support(@Path("appId")String appId, @Body SupportModel req,@Header("Authorization") String auth);
    ...
    Call<WebResponse<ImageDetails>> getProfilePix(@Query("custID") String custID,@Header("Authorization") String auth);

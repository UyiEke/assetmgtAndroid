 ...
 * {@link SubscriptionHistory.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link SubscriptionHistory#newInstance} factory method to
...
public class SubscriptionHistory extends Fragment {
    ...
    public static SubscriptionHistory newInstance(String param1, String param2) {
        actionType=param2;
        SubscriptionHistory fragment = new SubscriptionHistory();
    ...
    private void initUI(){
      ...
      recycler.setLayoutManager(layoutManager);
        ...
        if(list!=null){
            ...
            adapter=new RedemptionAdapter(list,context,2);
            recycler.setAdapter(adapter);
            getHistory("0");  // 0-subscription, 1-redemption
        }
